...
class Level
{
    ...
    constructor() {
        ...
        this.isAllowedForContext = CommandPermission.or(
            CommandPermission.isMemberMod,
            CommandPermission.isMemberSoft,
            CommandPermission.isMemberSubredditMod,
            CommandPermission.isMemberTutor,
        );
    }
